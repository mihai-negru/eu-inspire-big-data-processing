...
public class NameStatusValue {
    ...
    private final static String CODE_LIST = "http://inspire.ec.europa.eu/codelist/NameStatusValue/";

    @JsonCreator
    public NameStatusValue(@JacksonXmlProperty(isAttribute = true, localName = "href") final String href) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The code list value '" + href + "' is not a " + NameStatusValue.class.getName() + " value");
        }
