...
@Getter
public class GrammaticalGenderValue {
    @JsonIgnoreType
    public enum Enum {
        COMMON("common"),
        FEMININE("feminine"),
    ...
    private final static String CODE_LIST = "http://inspire.ec.europa.eu/codelist/GrammaticalGenderValue/";

    @JsonCreator
    public GrammaticalGenderValue(@JacksonXmlProperty(isAttribute = true, localName = "href") final String href) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The code list value '" + href + "' is not a " + GrammaticalGenderValue.class.getName() + " value");
        }
