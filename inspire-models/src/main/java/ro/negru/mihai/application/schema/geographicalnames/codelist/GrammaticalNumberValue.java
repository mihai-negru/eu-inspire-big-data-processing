...
@Getter
public class GrammaticalNumberValue {
    @JsonIgnoreType
    public enum Enum {
        DUAL("dual"),
        PLURAL("plural"),
    ...
    private final static String CODE_LIST = "http://inspire.ec.europa.eu/codelist/GrammaticalNumberValue/";

    @JsonCreator
    public GrammaticalNumberValue(@JacksonXmlProperty(isAttribute = true, localName = "href") final String href) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The code list value '" + href + "' is not a " + GrammaticalNumberValue.class.getName() + " value");
        }
