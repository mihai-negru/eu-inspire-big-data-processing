...
public class LegalStatusValue {
    ...
    private final static String CODE_LIST = "http://inspire.ec.europa.eu/codelist/LegalStatusValue/";

    @JsonCreator
    public LegalStatusValue(@JacksonXmlProperty(isAttribute = true, localName = "href") final String href) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The code list value '" + href + "' is not a " + LegalStatusValue.class.getName() + " value");
        }
