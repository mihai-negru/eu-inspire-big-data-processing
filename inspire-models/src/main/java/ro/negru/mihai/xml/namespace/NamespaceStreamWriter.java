...
public class NamespaceStreamWriter implements XMLStreamWriter2 {
    private final XMLStreamWriter2 delegate;
    private final Map<String, String> prefixToNs;
    private boolean rootWritten;

    public NamespaceStreamWriter(XMLStreamWriter2 delegate, Map<String, String> prefixToNs) {
        this.delegate = delegate;
        this.prefixToNs = prefixToNs;
    }

    private void onlyRootSpecs() throws XMLStreamException {
        if (rootWritten) return;
