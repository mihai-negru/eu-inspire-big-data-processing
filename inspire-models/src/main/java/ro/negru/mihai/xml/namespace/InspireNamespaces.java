...
public final class InspireNamespaces {
    ...
    public final static String GN = "http://inspire.ec.europa.eu/schemas/gn/4.0";
    ...
    public final static String AU = "http://inspire.ec.europa.eu/schemas/2025.1/au/5.0";
    public final static String AU_PREFIX = "au";

    public final static String GMD = "https://www.isotc211.org/2005/gmd";
    public final static String GMD_PREFIX = "gmd";

    public final static String BASE = "http://inspire.ec.europa.eu/schemas/2025.1/base/4.0";
